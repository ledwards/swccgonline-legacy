...
# script fixes
  # reset usable IDs
  # really delete the attr and char, and join tables
  
  # characteristics sometimes have leading and trailing spaces
  
  # droid types, creature defense
  # lore and gametext-based characteristics, gender
  # images for [Coruscant] and Force icons, maintenance
